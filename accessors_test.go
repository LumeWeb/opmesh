...
// JSON integer from a list operation into the string id a get/delete input
// schema expects, plus fallback to default for absent/uncoercible values.
...
// TestIntArg verifies coercion from the numeric shapes produced by callers
